...
namespace DotnetHttpClient
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        /// </summary>
        public Configuration(Uri basePath, IDictionary<string, string> defaultHeaders = default)
        {
            Proxy = null;
            UserAgent = "";
            BasePath = basePath;
        ...
        /// </summary>
        /// <value>The servers.</value>
        public IList<IReadOnlyDictionary<string, object>> Servers
        {
            get { return _servers; }
            set
            {
        ...
        public static IReadableConfiguration MergeConfigurations(IReadableConfiguration first, IReadableConfiguration second)
        {
            ...
            var config = new Configuration(second.BasePath ?? first.BasePath)
            {
                ApiKey = apiKey,
