...
namespace DotnetHttpClient
{
  public partial class ApiClient
  {
    ...
    public Task<T> GetAsync<T>(string path, RequestOptions options, CancellationToken cancellationToken = default)
    {
        return ExecAsync<T>(NewRequest(Method.GET, path, options), cancellationToken);
    }
    ...
    /// <param name="cancellationToken">Token that enables callers to cancel the request.</param>
    /// <returns>A Task containing ApiResponse</returns>
    public Task<T> PostAsync<T>(string path, RequestOptions options,CancellationToken cancellationToken = default)
    {
        return ExecAsync<T>(NewRequest(Method.POST, path, options), cancellationToken);
    }
    ...
    /// <param name="cancellationToken">Token that enables callers to cancel the request.</param>
    /// <returns>A Task containing ApiResponse</returns>
    public Task<T> PutAsync<T>(string path, RequestOptions options, CancellationToken cancellationToken = default)
    {
        return ExecAsync<T>(NewRequest(Method.PUT, path, options), cancellationToken);
    }
    ...
    /// <param name="cancellationToken">Token that enables callers to cancel the request.</param>
    /// <returns>A Task containing ApiResponse</returns>
    public Task<T> DeleteAsync<T>(string path, RequestOptions options, CancellationToken cancellationToken = default)
    {
        return ExecAsync<T>(NewRequest(Method.DELETE, path, options), cancellationToken);
    }
    ...
    /// <param name="cancellationToken">Token that enables callers to cancel the request.</param>
    /// <returns>A Task containing ApiResponse</returns>
    public Task<T> HeadAsync<T>(string path, RequestOptions options, CancellationToken cancellationToken = default)
    {
        return ExecAsync<T>(NewRequest(Method.HEAD, path, options), cancellationToken);
    }
    ...
    /// <param name="cancellationToken">Token that enables callers to cancel the request.</param>
    /// <returns>A Task containing ApiResponse</returns>
    public Task<T> OptionsAsync<T>(string path, RequestOptions options, CancellationToken cancellationToken = default)
    {
        return ExecAsync<T>(NewRequest(Method.OPTIONS, path, options), cancellationToken);
    }
    ...
    /// <param name="cancellationToken">Token that enables callers to cancel the request.</param>
    /// <returns>A Task containing ApiResponse</returns>
    public Task<T> PatchAsync<T>(string path, RequestOptions options, CancellationToken cancellationToken = default)
    {
        return ExecAsync<T>(NewRequest(Method.PATCH, path, options), cancellationToken);
    }
    ...
    /// </summary>
    private class CustomJsonCodec : ISerializer, IDeserializer
    {
